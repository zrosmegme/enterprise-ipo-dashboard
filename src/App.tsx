          ...
          <tr>
            ...
            >
              <div>
                ...
                <div className="text-[10px] font-normal text-gray-400">(as of Sep 19, 2025)</div>
              </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-8 text-center text-sm text-gray-500">
          ...
          <p className="mt-2 text-xs text-amber-600">
            ⚠️ Stock prices last updated: Sep 19, 2025 | IPO prices are historical | Acquisition prices reflect deal values
          </p>
        </div>
      </div>
    </div>
